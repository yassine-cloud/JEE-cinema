...
public class DaoReservation {
    ...
    public ArrayList<Reservation> getReservations() {
        ...
        try {
            ...
            while (rs.next()) {
                l.add(new Reservation(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getInt(4), rs.getDouble(5), rs.getDate(6)));
            }
            rs.close();
            ps.close();
    ...
    public Reservation getReservation(int id) {
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                r = new Reservation(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getInt(4), rs.getDouble(5), rs.getDate(6));
            }
            rs.close();
            ps.close();
        } catch (SQLException e) {

...
public class DaoUser {
	...
	public ArrayList<User> getUsers() {
		...
		try {
			...
			while (rs.next()) {
				l.add(new User(rs.getInt("id_user"), rs.getString("nom"), rs.getString("prenom"), rs.getString("email"),
	...
	public User getUser(int id) {
		...
		try {
			...
			ResultSet rs = ps.executeQuery();
			while (rs.next()) {
				u = new User(rs.getInt("id_user"), rs.getString("nom"), rs.getString("prenom"), rs.getString("email"),
						rs.getString("password"), rs.getString("role"));
			}
			rs.close();
			ps.close();

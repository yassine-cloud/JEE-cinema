...
public class ServletProjection extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( pathInfo == null ) {
			...
			if( request.getParameter("numhall") != null && request.getParameter("numfilm") != null && request.getParameter("date") != null && request.getParameter("heure") != null && request.getParameter("prix") != null ) {
			...
			if( request.getParameter("numprojection") != null && request.getParameter("numhall") != null && request.getParameter("numfilm") != null && request.getParameter("date") != null && request.getParameter("heure") != null && request.getParameter("prix") != null ) {

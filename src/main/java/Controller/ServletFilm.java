	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (pathInfo == null) {
			...
			if (request.getParameter("titre") != null && request.getParameter("description") != null
					&& request.getParameter("duration") != null && request.getParameter("genre") != null
					&& request.getParameter("directeur") != null && request.getParameter("img") != null) {
			...
			if (request.getParameter("id") != null) {
			...
			} else if (request.getParameter("idfilm") != null && request.getParameter("titre") != null
					&& request.getParameter("description") != null && request.getParameter("duration") != null
					&& request.getParameter("genre") != null && request.getParameter("directeur") != null
					&& request.getParameter("img") != null) {
				...
				response.sendRedirect(request.getContextPath() + "/admin/film");
			// request.getRequestDispatcher("/Film/editFilm.jsp").forward(request,
			// response);
		}
